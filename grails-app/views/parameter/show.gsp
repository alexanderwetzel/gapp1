...
<html>
    ...
    <body>
        ...
        <div id="show-parameter" class="content scaffold-show" role="main">
            ...
            <f:display bean="parameter" />
            <g:form resource="${this.parameter}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.parameter}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
